    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Grafik Pengeluaran BBM</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Grafik</a></li>
                        <li class="breadcrumb-item active">Pengeluaran BBM</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Pengeluaran BBM Pertamax</h4>
                        <div>
...
<script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Pengeluaran BBM Pertalite',
                data: <?php echo json_encode($dk) ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(60, 206, 34, 0.2)',
    ...
    var myGrafik = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Pengeluaran BBM Pertamax',
                data: <?php echo json_encode($dkx) ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(60, 206, 34, 0.2)',
